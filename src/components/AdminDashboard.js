...
const [searchResults, setSearchResults] = useState(null);
  ...
  const handleAddStudent = async () => {
    ...
    try {
      const response = await axios.post("https://gentle-paprenjak-f8e60c.netlify.app/api/auth/users", {
  ...
  const handleUpdateUser = async () => {
    ...
    try {
      const response = await axios.put("https://gentle-paprenjak-f8e60c.netlify.app/api/auth/users", {
        username: studentUsername,
 ...
 const handleSearch = async () => {
  ...
  try {
    const response = await axios.get(`https://gentle-paprenjak-f8e60c.netlify.app/api/auth/users/search?username=${searchQuery}`);
  ...
  const handleDeleteUser = async () => {
    ...
    try {
      const response = await axios.delete(`https://gentle-paprenjak-f8e60c.netlify.app/api/auth/users/${studentUsername}`);
      if (response.data.success) {
  ...
  const handleViewUserDetails = async () => {
    try {
      ...
      const response = await axios.get(`https://gentle-paprenjak-f8e60c.netlify.app/api/auth/users/${username}`);
